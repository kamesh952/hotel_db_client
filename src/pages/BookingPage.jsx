...
const BookingsPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || errorData.message || 'Failed to save booking');
      }
  ...
  const handleRemoveSpecialRequest = (index) => {
    ...
    setFormData({ ...formData, specialRequests: updatedRequests });
  };
      ...
      <div className="flex flex-col gap-2">
        ...
        {booking.status === "checked-in" && (
          <button
            ...
            className="w-full px-3 py-2 bg-green-600 text-white text-sm rounded-md hover:bg-green-700 transition-colors flex items-center justify-center"
          >
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="px-3 py-2 border border-gray-300 text-gray-700 text-sm rounded-md hover:bg-gray-50 transition-colors flex items-center justify-center"
          >
          ...
          <button
            ...
            className="px-3 py-2 border border-blue-300 text-blue-700 text-sm rounded-md hover:bg-blue-50 transition-colors flex items-center justify-center"
          >
        ...
        {booking.status !== 'checked-in' && (
          <button
            ...
            className="w-full px-3 py-2 border border-red-300 text-red-700 text-sm rounded-md hover:bg-red-50 transition-colors flex items-center justify-center"
          >
        ...
        {selectedBooking && (
          <div className="p-4 space-y-4">
            <div>
              ...
              <p className="font-mono text-sm">#{selectedBooking._id.slice(-6)}</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm">
                  ...
                  <br />
                  {new Date(selectedBooking.checkOut).toLocaleTimeString([], {
                    hour: "2-digit",
                    minute: "2-digit",
                  })}
                </p>
            ...
            <div>
              ...
              <span className={`inline-block mt-1 px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(selectedBooking.status)}`}>
            ...
            <div className="pt-4 space-y-2">
              ...
              <button
                ...
                className="w-full px-4 py-2 border border-blue-600 text-blue-600 rounded-md hover:bg-blue-50 transition-colors flex items-center justify-center"
              >
                <Edit2 className="mr-2" size={16} />
                Edit Booking
              </button>
        ...
        <div className="w-full max-w-7xl mx-auto p-3 sm:p-4 md:p-6 lg:p-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <button
              ...
              className={`flex items-center justify-center px-4 py-2 sm:py-2.5 rounded-md text-white transition-colors font-medium text-sm sm:text-base ${
                showForm
            ...
            <div className="bg-white rounded-lg shadow-md p-3 sm:p-4 md:p-6 mb-4 sm:mb-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <select
                        ...
                        className={`pl-10 w-full p-2.5 border ${
                          validationErrors.guest
                            ? "border-red-500"
                            : "border-gray-300"
                        } rounded-md focus:ring-blue-500 focus:border-blue-500 bg-white text-sm`}
                        required
                      >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className="pl-10 w-full p-2.5 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 text-sm"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="sm:col-span-2 lg:col-span-3">
                    ...
                    <div className="flex gap-2 mb-2">
                      <input
                        ...
                        className="flex-1 p-2.5 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 text-sm"
                        onKeyPress={(e) => {
                          if (e.key === 'Enter') {
                            e.preventDefault();
                      ...
                      <button
                        ...
                        className="px-4 py-2.5 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition-colors text-sm"
                      >
                        Add
                      </button>
                    </div>
                ...
                <div className="flex justify-center pt-4 sm:pt-6">
                  <button
                    type="submit"
                    className="w-full sm:w-auto min-w-[200px] px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 font-medium"
